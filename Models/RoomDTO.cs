...
namespace ModelsDTO
{
    public class CreateRoomDTO
    {
        ...
        [Range(1, 6, ErrorMessage ="De kamercapaciteit moet min. 1 en max. 6 personen bedragen.")]
        ...
        [Range(5, 1000, ErrorMessage ="De kameroppervlakte moet min. 5 en max. 1000 m² bedragen.")]
